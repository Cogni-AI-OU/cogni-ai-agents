...
- **Metacognitive Rewind Gate (Ablation Protocol)**: Execute the `Metacognitive_Rewind_Gate` defined in `FLOWS.mmd` when a contradiction is detected to prevent error cascades.
